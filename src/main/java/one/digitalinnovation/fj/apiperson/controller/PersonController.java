...
// Versão 2 ( versão 1 esta ao final da versão 2 com todos seus comentá rios )
// Controler é só um ponto de incio da API
// não tem lógica em colocar regras de negócio dentro dele

// ao criar a classe service fizemoa o desacoplamento
// e definimos responsabilodades unicas para cada uma das classes
